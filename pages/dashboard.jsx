      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <p>
            ...
            This application is simple and expandable.
          </p>
          <a
            href='https://github.com/Eugene-Pavlovskiy/next-dashboard-app'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://eugene-pavlovskiy.github.io/next-dashboard-app/'
            target='_blank'
            rel='noreferrer'
          >
